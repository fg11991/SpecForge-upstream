...
#
# Vendored from SGLang (python/sglang/srt/entrypoints/openai/encoding_dsv4.py
# at 059269594), which serves DeepSeek-V4 with exactly this encoder. Only the
# encoding half is kept: training must render a conversation the way serving
# renders a request, and never parses completions. Sync this file from the
# serving copy instead of editing it here.
"""
DeepSeek-V4 Encoding

A self-contained implementation for encoding DeepSeek-V4 chat messages
